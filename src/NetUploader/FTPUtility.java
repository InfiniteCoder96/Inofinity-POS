...
public class FTPUtility {
	...
	public void connect() throws FTPException {
		try {
			...
			throw new FTPException("Internet Connection Eror... " + ex.getMessage());
                        //JOptionPane.showMessageDialog(null, "Internet Connection Eror !" , "Eror" , JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	public void uploadFile(File uploadFile, String destDir) throws FTPException {
		try {
			...
			throw new FTPException("Error uploading file: " + ex.getMessage());
                        //JOptionPane.showMessageDialog(null, "Uploading Eror !" , "EROR" , JOptionPane.WARNING_MESSAGE);
		}
	}
