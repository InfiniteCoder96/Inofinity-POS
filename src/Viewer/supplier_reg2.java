 ...
 * @author Ashan Lakshitha
 */
public class supplier_reg2 extends javax.swing.JDialog {
    ...
    public supplier_reg2(java.awt.Frame parent, boolean modal , grnd in) {
        super(parent, modal);
        initComponents();
        i = in;
        setFrontText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(supplier_reg2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                supplier_reg2 dialog = new supplier_reg2(new javax.swing.JFrame(), true , null);
