 ...
 * @author Ashan Lakshitha
 */
public class customer_reg_date extends javax.swing.JDialog {
    ...
    public customer_reg_date(java.awt.Frame parent, boolean modal , invoice_date in) {
        super(parent, modal);
        initComponents();
        i = in;
        setFrontText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customer_reg_date.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                customer_reg_date dialog = new customer_reg_date(new javax.swing.JFrame(), true , null);
