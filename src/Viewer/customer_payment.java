 ...
 */
public class customer_payment extends javax.swing.JDialog {
    ...
    public customer_payment(java.awt.Frame parent, boolean modal , String cus , String user , Credit c) {
        super(parent, modal);
        initComponents();
        setFrontText();
        loginuser = user;
...
private void setFrontText() {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                customer_payment dialog = new customer_payment(new javax.swing.JFrame(), true , "0" , "admin" , null);
    ...
    private void paycash() {
        ...
        if(cashtxt.getText().isEmpty()){
            ...
            try {
                int j = d.audr("insert into customer_payment (customer_id, date, payment, payment_type, extra, user_usename, previous, due , t) values('"+cidtxt.getText()+"' , NOW() , '"+paymenttxt.getText()+"'  , 'Cash' , ' ' , '"+loginuser+"' , '"+balancelbl.getText()+"' , '"+duetxt.getText()+"' , '2' ) ");
