...
import NetUploader.JFilePicker;
...
public class SwingFileUploadFTP extends JFrame implements
	...
	private void buttonUploadActionPerformed(ActionEvent event) {
		String host = fieldHost.getText(); //www.zinasia.com
		int port = Integer.parseInt(fieldPort.getText()); //21
		String username = fieldUsername.getText(); // zinasiac
		String password = new String(fieldPassword.getPassword()); //7nvfwOE049
